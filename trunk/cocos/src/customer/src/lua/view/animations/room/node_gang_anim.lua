...
--Create node_gang
local node_gang=cc.Node:create()
node_gang:setName("node_gang")

--Create sp_gang
cc.SpriteFrameCache:getInstance():addSpriteFrames("assets/room/plist/operation.plist")
local sp_gang = cc.Sprite:createWithSpriteFrameName("i_operation_gang1.png")
sp_gang:setName("sp_gang")
sp_gang:setTag(26)
sp_gang:setCascadeColorEnabled(true)
sp_gang:setCascadeOpacityEnabled(true)
sp_gang:setPosition(-6.0000, 17.0000)
sp_gang:setScaleX(4.0000)
sp_gang:setScaleY(4.0000)
sp_gang:setOpacity(0)
layout = ccui.LayoutComponent:bindLayoutComponent(sp_gang)
...
sp_gang:setBlendFunc({src = 1, dst = 771})
node_gang:addChild(sp_gang)
...
layout:setLeftMargin(-28.5345)
layout:setRightMargin(-19.4655)
layout:setTopMargin(-52.6403)
layout:setBottomMargin(-13.3597)
sp_light:setBlendFunc({src = 1, dst = 1})
node_gang:addChild(sp_light)
...
PositionTimeline:setNode(sp_gang)
...
RotationSkewTimeline:setNode(sp_gang)
