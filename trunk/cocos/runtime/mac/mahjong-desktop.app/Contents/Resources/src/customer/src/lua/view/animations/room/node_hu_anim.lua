...
--Create node_hu
local node_hu=cc.Node:create()
node_hu:setName("node_hu")

--Create sp_bu
cc.SpriteFrameCache:getInstance():addSpriteFrames("assets/room/plist/operation.plist")
local sp_bu = cc.Sprite:createWithSpriteFrameName("i_operation_hu1.png")
sp_bu:setName("sp_bu")
sp_bu:setTag(60)
sp_bu:setCascadeColorEnabled(true)
sp_bu:setCascadeOpacityEnabled(true)
sp_bu:setScaleX(1.1000)
sp_bu:setScaleY(1.1000)
layout = ccui.LayoutComponent:bindLayoutComponent(sp_bu)
...
sp_bu:setBlendFunc({src = 1, dst = 771})
node_hu:addChild(sp_bu)

--Create sp_light
cc.SpriteFrameCache:getInstance():addSpriteFrames("assets/common/plist/light_1_1.plist")
local sp_light = cc.Sprite:createWithSpriteFrameName("10003.png")
...
PositionTimeline:setNode(sp_bu)
...
RotationSkewTimeline:setNode(sp_bu)
