...
cc.SpriteFrameCache:getInstance():addSpriteFrames("assets/room/plist/cards.plist")
img_bottom_bg2:loadTexture("mj_opposite_angang.png",1)
...
cc.SpriteFrameCache:getInstance():addSpriteFrames("assets/room/plist/cards.plist")
img_top_bg:loadTexture("mj_opposite_angang.png",1)
...
img_top_bg:setPosition(0.0000, 21.0000)
