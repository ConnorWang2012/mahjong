...
img_bg:loadTexture("mj_my_visible.png",1)
...
img_bg:setPosition(0.0000, 11.0000)
...
img_fg:setPosition(0.9985, 32.0000)
img_fg:setScaleX(0.8600)
img_fg:setScaleY(0.9000)
layout = ccui.LayoutComponent:bindLayoutComponent(img_fg)
layout:setSize({width = 102.0000, height = 124.0000})
layout:setLeftMargin(-50.0015)
layout:setRightMargin(-51.9985)
