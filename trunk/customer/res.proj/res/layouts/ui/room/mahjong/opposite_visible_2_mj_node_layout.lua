...
layout:setTopMargin(-46.7782)
layout:setBottomMargin(-26.2218)
...
img_top_bg:setPosition(0.0000, 27.2782)
layout = ccui.LayoutComponent:bindLayoutComponent(img_top_bg)
layout:setSize({width = 53.0000, height = 73.0000})
layout:setLeftMargin(-26.5000)
layout:setRightMargin(-26.5000)
layout:setTopMargin(-63.7782)
layout:setBottomMargin(-9.2218)
...
img_top_fg:setPosition(-0.0002, 37.4042)
img_top_fg:setScaleX(0.4500)
img_top_fg:setScaleY(0.3600)
...
layout:setTopMargin(-99.4042)
layout:setBottomMargin(-24.5958)
