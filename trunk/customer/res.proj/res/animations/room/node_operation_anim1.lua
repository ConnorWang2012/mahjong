...
cc.SpriteFrameCache:getInstance():addSpriteFrames("assets/room/plist/operation.plist")
img_operation1:loadTexture("i_operation_peng.png",1)
...
layout:setPercentHeight(1.0621)
layout:setSize({width = 171.0000, height = 171.0000})
layout:setLeftMargin(-2.5000)
layout:setRightMargin(243.5000)
