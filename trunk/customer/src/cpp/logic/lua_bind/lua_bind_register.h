...
TOLUA_API int tolua_room_list_msg_protocol_open(lua_State*);
...
TOLUA_API int tolua_table_msg_protocol_open(lua_State*);
...
TOLUA_API int tolua_personal_head_portrait_msg_protocol_open(lua_State*);
