...
// required string user_id = 1;
inline bool MyLoginMsgProtocol::has_user_id() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void MyLoginMsgProtocol::set_has_user_id() {
  _has_bits_[0] |= 0x00000001u;
}
inline void MyLoginMsgProtocol::clear_has_user_id() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void MyLoginMsgProtocol::clear_user_id() {
  if (user_id_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    user_id_->clear();
  }
  clear_has_user_id();
}
inline const ::std::string& MyLoginMsgProtocol::user_id() const {
  // @@protoc_insertion_point(field_get:gamer.protocol.MyLoginMsgProtocol.user_id)
  return *user_id_;
}
inline void MyLoginMsgProtocol::set_user_id(const ::std::string& value) {
  set_has_user_id();
  if (user_id_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    user_id_ = new ::std::string;
  }
  user_id_->assign(value);
  // @@protoc_insertion_point(field_set:gamer.protocol.MyLoginMsgProtocol.user_id)
}
inline void MyLoginMsgProtocol::set_user_id(const char* value) {
  set_has_user_id();
  if (user_id_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    user_id_ = new ::std::string;
  }
  user_id_->assign(value);
  // @@protoc_insertion_point(field_set_char:gamer.protocol.MyLoginMsgProtocol.user_id)
}
inline void MyLoginMsgProtocol::set_user_id(const char* value, size_t size) {
  set_has_user_id();
  if (user_id_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    user_id_ = new ::std::string;
  }
  user_id_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:gamer.protocol.MyLoginMsgProtocol.user_id)
}
inline ::std::string* MyLoginMsgProtocol::mutable_user_id() {
  set_has_user_id();
  if (user_id_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    user_id_ = new ::std::string;
  }
  // @@protoc_insertion_point(field_mutable:gamer.protocol.MyLoginMsgProtocol.user_id)
  return user_id_;
}
inline ::std::string* MyLoginMsgProtocol::release_user_id() {
  clear_has_user_id();
  if (user_id_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    return NULL;
  } else {
...
inline void MyLoginMsgProtocol::set_allocated_user_id(::std::string* user_id) {
  if (user_id_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete user_id_;
  }
  if (user_id) {
  ...
  // @@protoc_insertion_point(field_set_allocated:gamer.protocol.MyLoginMsgProtocol.user_id)
}
