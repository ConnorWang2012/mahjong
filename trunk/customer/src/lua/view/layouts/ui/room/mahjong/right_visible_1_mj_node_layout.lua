...
cc.SpriteFrameCache:getInstance():addSpriteFrames("assets/room/plist/cards.plist")
img_fg:loadTexture("bamboo_1.png",1)
...
img_fg:setPosition(4.9999, 12.9999)
img_fg:setScaleX(0.4500)
img_fg:setScaleY(0.4800)
img_fg:setRotationSkewX(90.0000)
img_fg:setRotationSkewY(90.0000)
