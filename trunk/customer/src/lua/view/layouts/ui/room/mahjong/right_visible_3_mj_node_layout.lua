...
cc.SpriteFrameCache:getInstance():addSpriteFrames("assets/room/plist/cards.plist")
img_top_fg1:loadTexture("character_7.png",1)
...
img_top_fg1:setPosition(-11.3602, 59.3584)
...
layout:setLeftMargin(-62.3602)
layout:setRightMargin(-39.6398)
layout:setTopMargin(-121.3584)
layout:setBottomMargin(-2.6416)
...
cc.SpriteFrameCache:getInstance():addSpriteFrames("assets/room/plist/cards.plist")
img_top_fg2:loadTexture("character_7.png",1)
...
img_top_fg2:setPosition(10.0000, 40.0000)
...
cc.SpriteFrameCache:getInstance():addSpriteFrames("assets/room/plist/cards.plist")
img_top_fg3:loadTexture("character_7.png",1)
...
img_top_fg3:setPosition(20.0000, -25.0000)
