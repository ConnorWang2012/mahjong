...
img_bg:loadTexture("mj_opposite_visible.png",1)
...
cc.SpriteFrameCache:getInstance():addSpriteFrames("assets/room/plist/cards.plist")
img_fg:loadTexture("character_9.png",1)
img_fg:setFlippedX(true)
img_fg:setFlippedY(true)
...
img_fg:setPosition(0.8999, 9.0022)
img_fg:setScaleX(0.4600)
img_fg:setScaleY(0.3000)
layout = ccui.LayoutComponent:bindLayoutComponent(img_fg)
layout:setSize({width = 102.0000, height = 124.0000})
layout:setLeftMargin(-50.1001)
layout:setRightMargin(-51.8999)
layout:setTopMargin(-71.0022)
layout:setBottomMargin(-52.9978)
